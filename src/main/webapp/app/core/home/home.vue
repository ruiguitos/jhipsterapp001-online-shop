  ...
  <div class="home row">
    ...
    <div class="col-md-9">
        ...
        >
            ...
            <br></br>
              <span v-text="$t('global.messages.info.register.noaccount')"></span>
                <br>
              <span> If you wish to have a new account in JHipster, please </span>
                <a class="alert-link" v-on:click="openLogin()" v-text="$t('global.messages.info.register.link')">.</a>
            <span>.</span>
        </div>
      </div>
                                                <!-- END TESTE REGISTRATION -->

      <p v-text="$t('home.question')">If you have any question on JHipster:</p>

      <ul>
        <li>
          <a href="https://www.jhipster.tech/" rel="noopener noreferrer" target="_blank"
        ...
        <li>
          <a href="https://gitter.im/jhipster/generator-jhipster" rel="noopener noreferrer" target="_blank"
             v-text="$t('home.link.chat')"
          >JHipster public chat room</a
          >
        </li>
        <li>
          <a href="https://twitter.com/jhipster" rel="noopener noreferrer" target="_blank"
             v-text="$t('home.link.follow')"
      ...
      <p>
        ...
        <a href="https://github.com/jhipster/generator-jhipster" rel="noopener noreferrer" target="_blank"
